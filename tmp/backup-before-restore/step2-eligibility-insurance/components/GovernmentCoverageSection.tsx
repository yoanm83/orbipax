 ...
 */
export function GovernmentCoverageSection({ onSectionToggle, isExpanded, form }: GovernmentCoverageSectionProps) {
        ...
        <CardBody id={`gov-${sectionUid}-panel`} aria-labelledby={`gov-${sectionUid}-header`} className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                id="gov-medicare-id"
                {...form.register('governmentCoverage.medicareId')}
            ...
            <div>
              ...
              <Input
                id="gov-ssn"
                {...form.register('governmentCoverage.socialSecurityNumber')}
                type="password"
