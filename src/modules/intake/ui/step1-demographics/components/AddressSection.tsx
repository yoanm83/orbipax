...
export function AddressSection({ onSectionToggle, isExpanded }: AddressSectionProps) {
  ...
  return (
    <Card className="w-full rounded-3xl shadow-md mb-6 @container">
      <div
        id="header-address"
        className="py-3 px-6 flex justify-between items-center cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring-primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--ring-offset-background)] min-h-[44px]"
